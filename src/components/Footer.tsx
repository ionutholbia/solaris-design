  ...
  <div className="container">
    <div className="row">
      <div className="col-md-4">
        <p>
          <img src={logo_solarisdesign2} alt="" className="img-fluid footer__logo" />
        </p>
        <p>
      ...
      <div className="col-md-7 offset-md-1">
        ...
        <div className="footer__contact">
          ...
          <div className="footer__contact-items">
            <p>
              <a href="https://www.facebook.com/Solaris-Design-Iasi-602610773087194/" target="_blank" rel="noreferrer">
                <i>
                  <BsFacebook />
                </i>{" "}
