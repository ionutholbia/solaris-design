      ...
      <div className="row">
        <div className="col-md-9">
          ...
          <h6>
            ...
            instalaţii termice şi de climatizare, instalaţii sanitare,
            instalaţii electrice şi proiectarea de reţele de alimentare cu apă
            şi gaze.
          </h6>
          <p>
            ...
            <div className="modele">
              <div className="modele__item">
                <a href="" onClick={()=>
                  ...
                  <p>
                    01.{" "}
                    <img src={mk_plus24_1} alt="Centrala Model Basic" className="img-fluid" />
                  </p>
                  <h5>Pachet Basic</h5>
                </a>
              </div>
              <div className="modele__item">
                <a href="" onClick={()=>
                  ...
                  <p>
                    02.{" "}
                    <img src={mk_dens25} alt="Centrala Model Medium" className="img-fluid" />
                  </p>
                  <h5>Pachet Mediu</h5>
                </a>
              </div>
              <div className="modele__item">
                <a href="" onClick={()=>
                  ...
                  <p>
                    03.{" "}
                    <img src={ariston_alteas_one_main} alt="Centrala model Premium" className="img-fluid" />
                  </p>
        ...
        <div className="col-md-6">
          <p>
            <a href="" onClick={()=>
              ...
              >
              <img src={solaris_design_iasi_2} alt="Solaris Design Iasi - Portofoliu" className="img-fluid" />
            </a>
          </p>
        </div>
      </div>
